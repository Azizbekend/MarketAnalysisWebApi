...
namespace MarketAnalysisWebApi.Migrations
{
    ...
    [Migration("20260403124522_NotificationsAddded")]
    partial class NotificationsAddded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.DbEntities.DbProjectRequest", b =>
                {
                    ...
                    b.Property<string>("ProjectDocsChapter")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.DbRequestConfigurations.KNS.DbEquipRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.DbRequestConfigurations.KNS.DbEquipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.DbRequestConfigurations.KNS.DbKnsConfiguration", b =>
                {
                    ...
                    b.Property<string>("InstalationPlace")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.FileStorages.DbOtherOfferFileModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DbBusinessAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DbBusinessAccountId");

                    b.HasIndex("OfferId");

                    b.ToTable("OtherOferFiles");
                });
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.Notifications.DbNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.DbRequestConfigurations.KNS.DbEquipRequest", b =>
                {
                    b.HasOne("MarketAnalysisWebApi.DbEntities.DbRequestConfigurations.KNS.DbEquipment", "Equipment")
            ...
            modelBuilder.Entity("MarketAnalysisWebApi.DbEntities.FileStorages.DbOtherOfferFileModel", b =>
                {
                    b.HasOne("MarketAnalysisWebApi.DbEntities.DbEntities.DbBusinessAccount", null)
                        .WithMany("OtherFiles")
                        .HasForeignKey("DbBusinessAccountId");

                    b.HasOne("MarketAnalysisWebApi.DbEntities.DbEntities.DbBusinessOffer", "Offer")
                        .WithMany()
